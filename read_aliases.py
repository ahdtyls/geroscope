...
if os.path.isfile('/home/maximk/Work/geroscope/retry_unprocess.pickle'):
    with open('/home/maximk/Work/geroscope/retry_unprocess.pickle', 'rb') as f:
        gero_dict = pickle.load(f)
elif os.path.isfile('/home/maximk/Work/geroscope/retry.pickle'):
    with open('/home/maximk/Work/geroscope/retry.pickle', 'rb') as f:
        gero_dict = pickle.load(f)
else:
    gero_dict = set_id_list(makedic(geroprot))
    with open('/home/maximk/Work/geroscope/retry.pickle', 'wb') as f:
